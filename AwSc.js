document.addEventListener("DOMContentLoaded", function () {
    const serverIp = 'Aweek.feathermc.gg';
    const serverPort = '25565';
    const serverIconElement = document.getElementById('serverIcon2');
    const serverInfoElement = document.getElementById('serverInfo2');
